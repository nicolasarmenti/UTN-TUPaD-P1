...
if palabra[-1] == "a" or palabra[-1] == "A" or palabra[-1] == "e" or palabra[-1] == "E" or palabra[-1] == "i" or palabra[-1] == "I" or palabra[-1] == "o" or palabra[-1] == "O" or palabra[-1] == "u" or palabra[-1] == "U":
    palabra = palabra + "!"
print(palabra)
...
hemisferio = input("Ingrese en qué emisferio se encuentra (N o S)")
