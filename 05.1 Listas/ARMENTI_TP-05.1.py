###
### UTN - TUPD 2025 - Programación 1 - TP Unidad 5.1 Listas
### Nicolás Corrado Armenti (Mat: 101035)
###

#1. Crear una lista con los números del 1 al 100 que sean múltiplos de 4. Utilizar la función range.
numeros1_100 = list(range(0, 101, 4))
...
# print(numeros)
###
# El programa remueve de la lista el valor más grade y muestra los restantes por pantalla
###

#6. Crear una lista con números del 10 al 30 (incluído), haciendo saltos de 5 en 5 y mostrar por pantalla los dos primeros.
lista_salto_5 = list(range(10, 31, 5))
print(lista_salto_5[:2])
